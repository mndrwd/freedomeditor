...
current_ext = 'xhtml-content';//this.options[this.selectedIndex].value;
jQuery("#cmmid").selectOptions("xhtml-content");
//document.getElementById('cmmid').options[xhtml-content].selected=true;
loadjscssfile(tmplfolder + '/js/xhtml-content.js', 'js');
