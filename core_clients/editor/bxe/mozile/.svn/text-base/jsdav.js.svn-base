...
Property.prototype = {
	...
	this.properties[this.properties.length] = obj;
    },
...
DavPropertyUpdate.prototype = {
    ...
    createXML: function(parent, doc) {
	node = doc.createElementNS("DAV:", "propertyupdate");
	for (var index = 0; index < this.removes.length; index++)
